...
//             0,
//         ];
//         const uint64 = BigIntUtilities.UInt64ToBigInt(uintArray);
...
//         const uintArray = [];
//         expect(() => {
//             BigIntUtilities.UInt64ToBigInt(uintArray);
...
//             const value = BigIntUtilities.UInt64ToBigInt([12, 12]);
//             const other = BigIntUtilities.UInt64ToBigInt([12, 12]);
//             expect(value.equals(other)).to.be.equal(true);
//         });

//         it('should return true if the inside values are the same but different order', () => {
//             const value = BigIntUtilities.UInt64ToBigInt([12, 23]);
//             const other = BigIntUtilities.UInt64ToBigInt([23, 12]);
...
//                 // Assert:
//                 expect(() => { BigInt('0000000012345G78'); }).to.throw('unrecognized hex char'); // contains 'G'
//             });
...
//                 // Assert:
//                 expect(() => { BigInt(''); }).to.throw(errorMessage); // empty string
//                 expect(() => { BigInt('1'); }).to.throw(errorMessage); // odd number of chars
//                 expect(() => { BigInt('ABCDEF12'); }).to.throw(errorMessage); // too short
//                 expect(() => { BigInt('1234567890ABCDEF12'); }).to.throw(errorMessage); // too long
//             });
//         });
//     });
...
//             expect(() => { BigInt('000012345678'); }).to.throw('Input string is not a valid numeric string');
//             expect(() => { BigInt('ABC12345678'); }).to.throw('Input string is not a valid numeric string');
//         });
//     });
