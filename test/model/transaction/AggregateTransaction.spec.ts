...
import { Cosignatory2Account, CosignatoryAccount, MultisigAccount, TestingAccount, TestNetworkType } from '../../conf/conf.spec';
...
describe('AggregateTransaction', () => {
    ...
    it('should createComplete an AggregateTransaction object with TransferTransaction', () => {
        ...
        expect(signedTransaction.payload.substring(424, signedTransaction.payload.length)).to.be.equal(
            '019854419826D27E1D0A26CA4E316F901E23E55C8711DB20DFD267760D0000000000000000746573742D6D657373616765000000',
        );
    });
    ...
    it('should createComplete an AggregateTransaction object with NamespaceRegistrationTransaction', () => {
        ...
        expect(signedTransaction.payload.substring(424, signedTransaction.payload.length)).to.be.equal(
            '01984E41E803000000000000CFCBE72D994BE69B0013726F6F742D746573742D6E616D657370616365000000',
        );
    });
    ...
    it('should createComplete an AggregateTransaction object with MosaicDefinitionTransaction', () => {
        ...
        expect(signedTransaction.payload.substring(424, signedTransaction.payload.length)).to.be.equal(
            '01984D410100000000000000E803000000000000E6DE84B807030000',
        );
    });
    ...
    it('should createComplete an AggregateTransaction object with MosaicSupplyChangeTransaction', () => {
        ...
        expect(signedTransaction.payload.substring(424, signedTransaction.payload.length)).to.be.equal(
            '01984D424CCCD78612DDF5CA0A000000000000000100000000000000',
        );
    });
    ...
    it('should createComplete an AggregateTransaction object with MultisigAccountModificationTransaction', () => {
        ...
        expect(signedTransaction.payload.substring(424, signedTransaction.payload.length)).to.be.equal(
            '019855410102020000000000989FC4844A5206CFA44603EFA1FFC76FE9B0564D9602198A986B4CB49ECF224FC4F0F4FCA2F6034305B3A47B0B4D1220',
        );
    });
    ...
    it('should createComplete an AggregateTransaction object with different cosignatories', () => {
        ...
        expect(signedTransaction.payload.substring(424, 424 + 162)).to.be.equal(
            '019854419826D27E1D0A26CA4E316F901E23E55C8711DB20DFD267760D0000000000000000746573742D6D657373616' +
                '76500000000000000000000000815926E003CDD5AF0113C0E067262307A42CD1E69',
        );
    });
    ...
    it('should validate if accounts have signed an aggregate transaction', () => {
        ...
        expect(
            aggregateTransaction.signedByAccount(
                PublicAccount.createFromPublicKey('A5F82EC8EBB341427B6785C8111906CD0DF18838FB11B51CE0E18B5E79DFF630', NetworkType.TEST_NET),
            ),
        ).to.be.equal(true);
        expect(
            aggregateTransaction.signedByAccount(
                PublicAccount.createFromPublicKey('7681ED5023141D9CDCF184E5A7B60B7D466739918ED5DA30F7E71EA7B86EFF2D', NetworkType.TEST_NET),
            ),
        ).to.be.equal(true);
        expect(
            aggregateTransaction.signedByAccount(
                PublicAccount.createFromPublicKey('B4F12E7C9F6946091E2CB8B6D3A12B50D17CCBBF646386EA27CE2946A7423DCF', NetworkType.TEST_NET),
            ),
        ).to.be.equal(false);
    ...
    it('Should be able to add cosignatures to current aggregate tx', () => {
        ...
        const cosignature = new AggregateTransactionCosignature(
            ...
            PublicAccount.createFromPublicKey(signedTransaction.signerPublicKey, NetworkType.TEST_NET),
        );
