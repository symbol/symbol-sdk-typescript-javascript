...
describe('MetadataEntry', () => {
    ...
    it('should createComplete an Account Metadata object', () => {
        ...
        deepEqual(
            '0100A8D66C33420E5411995BACFCA2B28CF1C9F5DD7AB181BFA8A8D66C33420E5411995BACFCA2B28CF1C9F5DD7AB181BFA844B262C46CEABB8500000000000000000005003132333435',
    ...
    it('should createComplete an Mosaic Metadata object', () => {
        ...
        const serialized = metadata.serialize();
        deepEqual(
            '0100A8D66C33420E5411995BACFCA2B28CF1C9F5DD7AB181BFA8A8D66C33420E5411995BACFCA2B28CF1C9F5DD7AB181BFA844B262C46CEABB8544B262C46CEABB850105003132333435',
            Convert.uint8ToHex(serialized),
        );
        deepEqual(serialized, MetadataEntryBuilder.loadFromBinary(serialized).serialize());
    });
