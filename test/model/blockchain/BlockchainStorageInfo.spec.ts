...
describe('BlockchainStorageInfo', () => {
    it('should createComplete an StorageInfo object', () => {
        ...
        expect(blockchainScore.numBlocks).to.be.equal(blockchainStorageInfoDTO.numBlocks);
        expect(blockchainScore.numTransactions).to.be.equal(blockchainStorageInfoDTO.numTransactions);
    });
});
