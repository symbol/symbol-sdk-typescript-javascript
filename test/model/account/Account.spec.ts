...
describe('Account', () => {
    const accountInformation = {
        address: 'TDLGYM2CBZKBDGK3VT6KFMUM6HE7LXL2WGIUNBY',
    ...
    it('should be created via private key', () => {
        const account = Account.createFromPrivateKey(accountInformation.privateKey, NetworkType.TEST_NET);
    ...
    it('should throw exception when the private key is not valid', () => {
        expect(() => {
            Account.createFromPrivateKey('', NetworkType.TEST_NET);
        }).to.throw();
    });
