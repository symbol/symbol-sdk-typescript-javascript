...
### _Catapult-Server_ Network Compatibility (catapult-server@0.10.0.5)

Symbol network pre-launch [catapult-server](https://github.com/nemtech/catapult-server/releases/tag/v0.10.0.5), **it is recommended to use this package's 0.23.1 version and upwards for the upcoming pre-release versions and final release**.
