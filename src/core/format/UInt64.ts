 ...
 * @returns {module:coders/uint64~uint64} The uint64 representation of the input.
 */
export const fromBytes = (uint8Array) => {
 ...
 * @returns {module:coders/uint64~uint64} The uint64 representation of the input.
 */
export const fromBytes32 = (uint8Array) => {
 ...
 */
export const isZero = (uint64) => 0 === uint64[0] && 0 === uint64[1];
