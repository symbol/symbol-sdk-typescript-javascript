...
export class NetworkConfigurationHelpers {
  ...
  public static maxMosaicDivisibility(networkConfiguration: NetworkConfiguration | undefined,
    defaultValue: number | undefined = undefined): number {
    return (networkConfiguration && networkConfiguration.plugins && networkConfiguration.plugins.mosaic &&
      Formatters.configurationNumberAsNumber(networkConfiguration.plugins.mosaic.maxMosaicDivisibility))
      || defaultValue || this.defaults.maxMosaicDivisibility
  }

  public static maxNamespaceDepth(networkConfiguration: NetworkConfiguration | undefined,
    defaultValue: number | undefined = undefined): number {
    return (networkConfiguration && networkConfiguration.plugins && networkConfiguration.plugins.namespace &&
      Formatters.configurationNumberAsNumber(networkConfiguration.plugins.namespace.maxNamespaceDepth))
      || defaultValue || this.defaults.maxNamespaceDepth
  }


  public static namespaceGracePeriodDuration(networkConfiguration: NetworkConfiguration | undefined,
    defaultValue: number | undefined = undefined): number {
    return (networkConfiguration && networkConfiguration.plugins && networkConfiguration.plugins.namespace &&
      TimeHelpers.durationStringToSeconds(networkConfiguration.plugins.namespace.namespaceGracePeriodDuration))
      || defaultValue || this.defaults.namespaceGracePeriodDuration
  }

  public static maxCosignatoriesPerAccount(networkConfiguration: NetworkConfiguration | undefined,
    defaultValue: number | undefined = undefined): number {
    return (networkConfiguration && networkConfiguration.plugins && networkConfiguration.plugins.multisig &&
      Formatters.configurationNumberAsNumber(networkConfiguration.plugins.multisig.maxCosignatoriesPerAccount))
      || defaultValue || this.defaults.maxCosignatoriesPerAccount
  }

  public static blockGenerationTargetTime(networkConfiguration: NetworkConfiguration | undefined,
    defaultValue: number | undefined = undefined): number {
  ...
  public static lockedFundsPerAggregate(networkConfiguration: NetworkConfiguration | undefined,
    defaultValue: string | undefined = undefined): string {
    return (networkConfiguration && networkConfiguration.plugins && networkConfiguration.plugins.lockhash &&
      Formatters.configurationNumberAsString(networkConfiguration.plugins.lockhash.lockedFundsPerAggregate))
      || defaultValue || this.defaults.lockedFundsPerAggregate
  }


  public static maxMosaicDuration(networkConfiguration: NetworkConfiguration | undefined,
    defaultValue: number | undefined = undefined): number {
    return (networkConfiguration && networkConfiguration.plugins && networkConfiguration.plugins.mosaic &&
      TimeHelpers.durationStringToSeconds(networkConfiguration.plugins.mosaic.maxMosaicDuration))
      || defaultValue || this.defaults.maxMosaicDuration
  }


  public static minNamespaceDuration(networkConfiguration: NetworkConfiguration | undefined,
    defaultValue: number | undefined = undefined): number {
    return (networkConfiguration && networkConfiguration.plugins && networkConfiguration.plugins.namespace &&
      TimeHelpers.durationStringToSeconds(networkConfiguration.plugins.namespace.minNamespaceDuration))
      || defaultValue || this.defaults.minNamespaceDuration
  }

  public static maxNamespaceDuration(networkConfiguration: NetworkConfiguration | undefined,
    defaultValue: number | undefined = undefined): number {
    return (networkConfiguration && networkConfiguration.plugins && networkConfiguration.plugins.namespace &&
      TimeHelpers.durationStringToSeconds(networkConfiguration.plugins.namespace.maxNamespaceDuration))
      || defaultValue || this.defaults.maxNamespaceDuration
  }

  public static maxTransactionsPerAggregate(networkConfiguration: NetworkConfiguration | undefined,
    defaultValue: number | undefined = undefined): number {
    return (networkConfiguration && networkConfiguration.plugins && networkConfiguration.plugins.aggregate &&
  ...
  public static maxCosignedAccountsPerAccount(networkConfiguration: NetworkConfiguration | undefined,
    defaultValue: number | undefined = undefined): number {
    return (networkConfiguration && networkConfiguration.plugins && networkConfiguration.plugins.multisig &&
      Formatters.configurationNumberAsNumber(networkConfiguration.plugins.multisig.maxCosignedAccountsPerAccount))
      || defaultValue || this.defaults.maxCosignedAccountsPerAccount
  }

  public static maxMessageSize(networkConfiguration: NetworkConfiguration | undefined,
    defaultValue: number | undefined = undefined): number {
    return (networkConfiguration && networkConfiguration.plugins && networkConfiguration.plugins.transfer &&
      Formatters.configurationNumberAsNumber(networkConfiguration.plugins.transfer.maxMessageSize))
      || defaultValue || this.defaults.maxMessageSize
  }

  public static maxMosaicAtomicUnits(networkConfiguration: NetworkConfiguration | undefined,
    defaultValue: number | undefined = undefined): number {
    return (networkConfiguration && networkConfiguration.chain &&
