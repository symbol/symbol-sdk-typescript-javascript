    ...
    <div class="transaction-details-container scroll">
      ...
      >
        ...
        <div v-if="t.mosaics" class="asset-item">
          <span>{{ $t('assets') }}:</span>
          <div
            v-for="(a, mosaicIndex) in renderMosaicsAndReturnArray(t.mosaics, $store)"
            :key="mosaicIndex"
            class="modify-item"
          >
            <div v-if="!a.name">
            ...
            <div>
              ...
              <NumberFormatting :number-of-formatting="a.amount" />
            </div>
          </div>
          <div v-if="t.message">
            <span>{{ $t('message') }}:</span>
        ...
        <div v-if="t.cosignatories" class="asset-item">
          ...
          <div
            v-for="(item, cosignatoryIndex) in t.cosignatories.modifications"
            :key="cosignatoryIndex"
            class="modify-item"
          >
            <div>
        ...
        <div v-if="cosignedBy && cosignedBy.length" class="asset-item">
          ...
          <div v-for="(item, cosignedByIndex) in cosignedBy" :key="cosignedByIndex" class="modify-item">
            <div>
              <span class="title">{{ cosignedByIndex + 1 }}:&nbsp;</span>
