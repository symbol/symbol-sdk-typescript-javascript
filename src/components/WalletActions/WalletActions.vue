    ...
    <div class="single-harvesting-option">
      ...
      <div class="harvesting-options">
        <div class="harvesting-item">
          <div class="img-box radius"><img src="@/views/resources/img/symbol/Link.png"></div>
          <p class="access-name">{{ $t('wallets_harvesting_tile_remote') }}</p>
          <p class="access-info">{{ $t('wallets_harvesting_tile_remote_description') }}</p>
        </div>
      </div>
    </div>
    <div class="single-harvesting-option">
      ...
      <div class="harvesting-options">
        <div class="harvesting-item">
          ...
          <p class="access-name">{{ $t('wallets_harvesting_tile_request') }}</p>
          <p class="access-info">{{ $t('wallets_harvesting_tile_request_description') }}</p>
        </div>
      </div>
    </div>
  </div>
