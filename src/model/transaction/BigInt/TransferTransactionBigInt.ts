...
import { TransactionBigInt } from './TransactionBigInt';
import { InnerTransactionBigInt } from './InnerTransactionBigInt';
import { BigIntConvertUtil } from './BigIntConvertUtil';

/**
 * Transfer transactions contain data about transfers of mosaics and message to another account.
 */
export class TransferTransactionBigInt extends TransactionBigInt {
    /**
    ...
    public static create(deadline: Deadline,
                         ...
                         maxFee: BigInt = BigInt(0)): TransferTransactionBigInt {
        return new TransferTransactionBigInt(networkType,
    ...
    public static createFromPayload(payload: string,
                                    isEmbedded: boolean = false): TransactionBigInt | InnerTransactionBigInt {
        ...
        const transaction = TransferTransactionBigInt.create(
            ...
            networkType,
            isEmbedded ? BigInt(0) :
                BigInt(BigIntConvertUtil.UInt64ToBigInt((builder as TransferTransactionBuilder).fee.amount)),
        );
        return isEmbedded ?
    ...
    protected generateBytes(): Uint8Array {
        ...
        const transactionBuilder = new TransferTransactionBuilder(
            ...
            new AmountDto(BigIntConvertUtil.BigIntToUInt64(this.maxFee)),
     ...
     * @returns {TransferTransaction}
     */
    public resolveAliases(statement: Statement, aggregateTransactionIndex: number = 0): TransferTransactionBigInt {
