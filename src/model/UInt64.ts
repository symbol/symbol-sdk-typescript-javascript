...
//      * @returns {UInt64}
//      */
//     public static fromUint(value: number): bigint {
//         if (value < 0) {
//             throw new Error('Unsigned integer cannot be negative');
//         }
//         return BigIntUtilities.UInt64ToBigInt(BigInt(value));
//     }
...
//      */
//     public static fromHex(input: string): bigint {
//         const dto = BigInt(input);
//         return BigIntUtilities.UInt64ToBigInt(dto);
//     }
...
//      * @returns {module:coders/uint64~uint64} The uint64 representation of the input.
//      */
//     public static fromNumericString(input: string): bigint {
...
//         return BigIntUtilities.UInt64ToBigInt([input_long.getLowBitsUnsigned(), input_long.getHighBitsUnsigned()]);
//     }
...
//      */
//     public compare(other: bigint): number {
...
//      */
//     private longToUint64(longValue: Long): bigint {
//         return BigIntUtilities.UInt64ToBigInt([longValue.getLowBitsUnsigned(), longValue.getHighBitsUnsigned()]);
//     }
// }
