<template>
  <div class="mosaicList ">
    <div class="mosaicListBody scroll">
      <div class="listTit">
        <Row>
          ...
          <Col span="4">{{$t('effective_time')}} ( blocks ) </Col>
      ...
      <div class="listItem" v-if="key !== 'length'" v-for="(value,key,index) in mosaicMapInfo">
        <Row>
          ...
          <Col span="4">{{value._duration > $store.state.app.chainStatus.currentHeight?
            (value._duration - $store.state.app.chainStatus.currentHeight): '0'}}
          </Col>
          <Col span="3">null</Col>
          <Col span="2">
            <div class="listFnDiv">
              <Poptip placement="bottom">
                ...
                <div slot="content" class="updateFn">
                  ...
                  <p class="fnItem" v-if="value._duration > $store.state.app.chainStatus.currentHeight"
                     @click="showAliasDialog(value)">
    ...
    <MosaicAliasDialog :currentMosaic='currentMosaic' :showMosaicAliasDialog="showMosaicAliasDialog"
...
<script lang="ts">
    ...
    export default class MosaicList extends Vue {
        ...
        showAliasDialog(currentMosaic) {
            // console.log(currentMosaic )
                    ...
                    mosaicInterface.getMosaics({
                        ...
                        mosacListResult.result.mosaicsInfos.subscribe((mosaicListInfo: any) => {
                            ...
                            mosaicListInfo.forEach((item) => {
                                ...
                                item._duration = item.properties.duration.compact() + item.height.compact()
