...
<script lang="ts">
    import {MultisigTransactionsTs} from './MultisigTransactionsTs'

    export default class MultisigManagement extends MultisigTransactionsTs {
    }
</script>
<style scoped lang="less">
  @import "./MultisigTransactions.less";
</style>
