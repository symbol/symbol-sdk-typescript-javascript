...
<script lang="ts">
    import './SeedCreatedGuide.less'
    //@ts-ignore
    import {SeedCreatedGuideTs} from '@/views/login/init-seed/seed-created-guide/SeedCreatedGuideTs.ts'

    export default class SeedCreatedGuide extends SeedCreatedGuideTs {
