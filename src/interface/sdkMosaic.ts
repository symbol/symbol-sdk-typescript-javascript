import { MosaicDefinitionTransaction, Deadline, MosaicNonce,MosaicId,
  MosaicProperties, UInt64, MosaicSupplyChangeTransaction, MosaicHttp, Convert } from 'nem2-sdk'
