...
export const APIS = [AccountRoutesApi, BlockRoutesApi, ChainRoutesApi, DiagnosticRoutesApi, MetadataRoutesApi, MosaicRoutesApi, MultisigRoutesApi, NamespaceRoutesApi, NetworkRoutesApi, NodeRoutesApi, ReceiptRoutesApi, RestrictionAccountRoutesApi, RestrictionMosaicRoutesApi, TransactionRoutesApi];
