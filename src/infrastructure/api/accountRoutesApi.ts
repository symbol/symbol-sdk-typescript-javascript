...
export class AccountRoutesApi {
     ...
     */
    public async getAccountConfirmedTransactions (accountId: string, pageSize?: number, id?: string, ordering?: string, transactionType?: TransactionTypeEnum, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Array<TransactionInfoDTO>;  }> {
        ...
        if (transactionType !== undefined) {
            localVarQueryParameters['transactionType'] = ObjectSerializer.serialize(transactionType, "TransactionTypeEnum");
        }
     ...
     * @param transactionType Transaction type to filter by.
     */
    public async getAccountIncomingTransactions (accountId: string, pageSize?: number, id?: string, ordering?: string, transactionType?: TransactionTypeEnum, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Array<TransactionInfoDTO>;  }> {
     ...
     * @param transactionType Transaction type to filter by.
     */
    public async getAccountOutgoingTransactions (accountId: string, pageSize?: number, id?: string, ordering?: string, transactionType?: TransactionTypeEnum, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Array<TransactionInfoDTO>;  }> {
     ...
     * @param transactionType Transaction type to filter by.
     */
    public async getAccountPartialTransactions (accountId: string, pageSize?: number, id?: string, ordering?: string, transactionType?: TransactionTypeEnum, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Array<TransactionInfoDTO>;  }> {
     ...
     * @param transactionType Transaction type to filter by.
     */
    public async getAccountUnconfirmedTransactions (accountId: string, pageSize?: number, id?: string, ordering?: string, transactionType?: TransactionTypeEnum, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Array<TransactionInfoDTO>;  }> {
