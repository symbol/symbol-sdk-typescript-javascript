...
export class BlockRoutesApi {
     ...
     */
    public async getBlocksByHeightWithLimit (height: string, limit: 25 | 50 | 75 | 100, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Array<BlockInfoDTO>;  }> {
