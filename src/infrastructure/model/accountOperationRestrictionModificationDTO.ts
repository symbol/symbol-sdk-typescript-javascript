...
export class AccountOperationRestrictionModificationDTO {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "baseName": "modificationAction",
            "type": "AccountRestrictionModificationActionEnum"
        },
        {
            "name": "value",
            "baseName": "value",
    ...
    static getAttributeTypeMap() {
        return AccountOperationRestrictionModificationDTO.attributeTypeMap;
    }
}
